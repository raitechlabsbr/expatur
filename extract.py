...
SRC = '/home/israel/Documentos/expatur/indexold.html'
...
# Append imports for custom modules that are NOT part of index.html extraction
CSS_EXTRA_IMPORTS = [
    '/* Custom modules — not regenerated by extract.py */',
    "@import './modal-alert.css';",
]
css_final = '\n'.join(CSS_EXTRA_IMPORTS) + '\n\n' + css_combined + '\n'
...
with open(f'{BASE}/index.html', 'w', encoding='utf-8') as f:
    f.write(shell)
print(f'✓ Shell → index.html             ({len(shell)//1024}KB)')
